...
set(tools $ENV{HOME}/ti/gcc-arm-none-eabi_9_3_1)
...
#libgcc.a is here
link_directories(${tools}/lib/gcc/arm-none-eabi/9.3.1/thumb/v7e-m+fp/hard)
...
add_link_options(
  ...
  -static
  --specs=nano.specs
  -Wl,-T${CMAKE_CURRENT_LIST_DIR}/tm4c1294ncpdt.lds
  -Wl,--gc-sections
  -Wl,-Map,tm4c1294xl.map
