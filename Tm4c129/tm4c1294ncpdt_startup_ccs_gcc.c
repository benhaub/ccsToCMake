...
void __attribute__((naked)) ResetISR(void)
{
    ...
    //First thing the in vector table is the top of the stack. Grab it and set the stack pointer.
    __asm__ __volatile__(" movw r0, #:lower16:g_pfnVectors\n"
                         " movt r0, #:upper16:g_pfnVectors\n"
                         " ldr r0, [r0]\n"
                         " mov sp, r0\n"
