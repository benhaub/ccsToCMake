...
if(${CMAKE_HOST_SYSTEM_NAME} STREQUAL "Linux" OR ${CMAKE_HOST_SYSTEM_NAME} STREQUAL "Darwin")
  ...
  set(CCS_PROJECT $ENV{HOME}/workspace_v12/capturepwmdisplay_CC3220SF_LAUNCHXL_freertos_gcc)
  set(CCS_PROJECT_LINK capturepwmdisplay_CC3220SF_LAUNCHXL_freertos_gcc)
...
#Grab all the generated source files from the sysconfig folder
file(GLOB sysconfigCSource LIST_DIRECTORIES false ${CMAKE_CURRENT_LIST_DIR}/${CCS_PROJECT_LINK}/${SYSCONFIG_TYPE}/syscfg/*.c)
file(GLOB sysconfigCxxSource LIST_DIRECTORIES false ${CMAKE_CURRENT_LIST_DIR}/${CCS_PROJECT_LINK}/${SYSCONFIG_TYPE}/syscfg/*.cpp)